...
public class FileConstant {
    ...
    public static final String USER_FOLDER = System.getProperty("user.home") + "/backend_us/user/";
    public static final String DIRECTORY_CREATED = "Created Directory for: ";
    public static final String DEFAULT_USER_IMAGE_PATH = "/user/image/profile/";
    public static final String FILE_SAVED_IN_THE_SYSTEM = "Saved file in the file system by name: ";
